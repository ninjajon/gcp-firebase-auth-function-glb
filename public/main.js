...
function Demo() {
  document.addEventListener('DOMContentLoaded', function() {
    ...
    //this.helloUserUrl = 'https://northamerica-northeast1-jo-firebase-auth-fct-glb-jxba.cloudfunctions.net/app/hello'
    this.helloUserUrl = 'https://api-dev.ninjajon.com/app/hello'
